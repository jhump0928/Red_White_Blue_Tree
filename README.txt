...
completely exit from an operation, backspace until the entry box is empty, and press 'c' for confirm.

Some of the restrictions on our tree include:
- The maximum displayable height of our tree is 5 levels, supporting a maximum of 32 nodes in a perfect binary tree.
